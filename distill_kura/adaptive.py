...
# The floors live in their own module (W2a); re-exported here so the old
# `adaptive.<name>` spellings keep working.
from .floors import (first_violation, _ARROW, _IDENT, _LINK, _NEG_EN, _NEG_JA,  # noqa: F401
                     _NUM, _OBSOLETE, _bound_numbers, _idents, _negations, _nfkc)
from .store import Store
from .tokens import estimate
from .weave import ENTRY, LEDGER_VERSION, MULTI, Loom
...
class Adaptive:
    ...
    def floor(self, cand: str, title: str, desc: str) -> str | None:
        ...
        return first_violation(cand, title, desc, self.loom)
